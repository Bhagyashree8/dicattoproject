        ...
        stylesheets: {
            main: {
                ...
                list: [
                    ...
                    {file: "css/styles/sea.css", name: "Sea", colors: ["#13bfb1"]},
                    {file: "css/styles/brown.css", name: "Brown", colors: ["#825339"]},
                    {file: "css/styles/light-green.css", name: "Light-Green", colors: ["#97cc02"]},
                    {file: "css/styles/chocolate.css", name: "Chocolate", colors: ["#ed703a"]}

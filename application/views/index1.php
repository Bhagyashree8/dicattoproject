...
<!-- =========================
    Pricing Plan
    ========================== -->
      <div class="col-md-12 text-center"  style="padding-bottom:15px; margin-bottom: 18px;">
                <h2 class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s" style="font-weight: 600;">Strengthening Indian Retailers through Digitalization & Networking</h2>
       </div>
    ...
    <div class="container">
        <div class="row">
              ...
              <div class="col-md-12 heading">
                <h2 class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">Salient Features</h2>
            </div>
            
            <div class="pricing-wrapper text-center">
                <div class="row">
                    <div class="col-sm-3 no-padding wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
                        <div class="description-images text-center">
                        <img src="<?php echo base_url();?>assets/home/images/business.png" class="img-responsive center">
                        </div>
                    ...
                    <div class="col-sm-3 no-padding wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
                        <div class="description-images text-center">
                        <img class="descriptionimg text-center" src="<?php echo base_url();?>assets/home/images/consumer.png" class="img-responsive center">
                        </div>
                    ...
                    <div class="col-sm-3 no-padding wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
                        <div class="description-images text-center">
                        <img class="" src="<?php echo base_url();?>assets/home/images/gift.png" class="img-responsive center">
                        </div>
                     ...
                     <div class="col-sm-3 no-padding wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
                        <div class="description-images text-center">
                        <img src="<?php echo base_url();?>assets/home/images/customer.png" class="img-responsive center">
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-5 col-sm-12  text-center">
                ...
                <div class="ad-frame-two wow fadeInUp aboutmo" data-wow-duration="1.5s" data-wow-delay=".4s">
            ...
            <div class="col-sm-7 col-sm-12">
                ...
                <div class="col-md-12 app-description-content wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
                    <ul class="" style="font-size: 19px;line-height: 35px;color: #fff;">
                    ...
                    <p class="about-text" style="font-size: 19px;line-height: 35px;color: #fff;">
...
<section class="contact" id="contact">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
